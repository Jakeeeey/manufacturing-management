...
// eslint-disable-next-line @typescript-eslint/no-unused-vars
    ...
    return (
        <div className="space-y-4">
            {/* Filters Header */}
            <div className="flex flex-col gap-4 bg-card p-5 rounded-2xl border border-slate-200/80 shadow-sm border-t-2 border-t-slate-800">
                                        ...
                                        <td className="p-4 text-center">
                                            <div className="flex items-center justify-center">
                                                <button
                                                    ...
                                                    className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-lg border border-slate-200 bg-white hover:bg-slate-50 hover:border-slate-300 text-slate-600 font-bold transition-all text-[11px] shadow-xs cursor-pointer"
