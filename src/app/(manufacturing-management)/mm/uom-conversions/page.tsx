...
import UOMConversionsModule from "@/modules/manufacturing-management/uom-conversions/UOMConversionsModule";

export const runtime = "nodejs";
export const dynamic = "force-dynamic";

export const metadata = {
    title: "UOM Conversions & Density Matrix | VOS ERP",
    description: "Manage volume-to-mass conversions, configure specific gravity coefficients for recipes, and validate scales."
};
                        ...
                        <Breadcrumb>
                            <BreadcrumbList className="min-w-0 overflow-hidden">
                                ...
                                <BreadcrumbItem className="min-w-0 overflow-hidden">
                                    <BreadcrumbPage className="truncate">UOM Conversions</BreadcrumbPage>
                                </BreadcrumbItem>
                            </BreadcrumbList>
                        </Breadcrumb>
                    </div>
