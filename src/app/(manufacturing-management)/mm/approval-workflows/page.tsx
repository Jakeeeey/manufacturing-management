...
import ApprovalWorkflowsModule from "@/modules/manufacturing-management/approval-workflows/ApprovalWorkflowsModule";
                        ...
                        <Breadcrumb>
                            <BreadcrumbList className="min-w-0 overflow-hidden">
                                ...
                                <BreadcrumbItem className="min-w-0 overflow-hidden">
                                    <BreadcrumbPage className="truncate">Approval Thresholds</BreadcrumbPage>
                                </BreadcrumbItem>
                            </BreadcrumbList>
                        </Breadcrumb>
                    </div>
