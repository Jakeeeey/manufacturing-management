...
import CalendarOfScheduleModule from "@/modules/manufacturing-management/calendar-of-schedule/CalendarOfScheduleModule";
...
export default async function CalendarOfSchedulePage() {
