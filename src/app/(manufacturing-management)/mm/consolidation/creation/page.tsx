...
import InvoiceConsolidationModule from "@/modules/manufacturing-management/invoice-consolidation/InvoiceConsolidationModule";
...
export default async function ConsolidationCreationPage() {
