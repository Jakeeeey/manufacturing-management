...
import InventoryReportsModule from "@/modules/manufacturing-management/inventory-reports/InventoryReportsModule";

export const dynamic = "force-dynamic";

export const metadata = {
    title: "Inventory Reports | VOS ERP",
    description: "Lot utilization, stock ledger cards, and FEFO batch expiry analytics."
};
    ...
    return (
        <div className="flex min-h-0 min-w-0 flex-1 flex-col overflow-hidden">
            ...
            <main className="min-h-0 min-w-0 flex-1 overflow-y-auto overflow-x-hidden p-4 sm:p-6 bg-background space-y-4">
                <div>
                    <h2 className="text-xl font-extrabold tracking-tight text-foreground">Inventory Movement Reports</h2>
                    <p className="text-muted-foreground text-[11px] mt-0.5">
                        Lot utilization, stock ledger cards, and FEFO batch expiry analytics.
                    </p>
                </div>
