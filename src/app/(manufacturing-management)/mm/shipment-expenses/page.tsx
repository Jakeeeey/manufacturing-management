...
import ProcurementModule from "@/modules/manufacturing-management/procurement/ProcurementModule";
...
export default async function ShipmentExpensesPage() {
