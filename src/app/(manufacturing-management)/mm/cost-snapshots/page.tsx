...
import CostSnapshotsModule from "@/modules/manufacturing-management/cost-snapshots/CostSnapshotsModule";

export const runtime = "nodejs";
export const dynamic = "force-dynamic";

export const metadata = {
    title: "Cost Snapshots & Auditing | VOS ERP",
    description: "Audit historical bill-of-materials costs frozen at quotation issuance against live recipe costs."
};
...
export default async function CostSnapshotsPage() {
                        ...
                        <Breadcrumb>
                            <BreadcrumbList className="min-w-0 overflow-hidden">
                                ...
                                <BreadcrumbItem className="min-w-0 overflow-hidden">
                                    <BreadcrumbPage className="truncate">Cost Snapshots</BreadcrumbPage>
                                </BreadcrumbItem>
                            </BreadcrumbList>
                        </Breadcrumb>
                    </div>
