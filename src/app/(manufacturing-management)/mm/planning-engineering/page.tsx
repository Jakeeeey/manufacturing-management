...
import PlanningEngineeringModule from "@/modules/manufacturing-management/planning-engineering/PlanningEngineeringModule";
...
export default async function PlanningEngineeringPage() {
                            ...
                            <BreadcrumbList className="min-w-0 overflow-hidden">
                                ...
                                <BreadcrumbItem className="min-w-0 overflow-hidden">
                                    <BreadcrumbPage className="truncate max-w-[56vw] sm:max-w-[60vw] md:max-w-none">
                                        Planning & Engineering (JO Scheduling)
                                    </BreadcrumbPage>
                                </BreadcrumbItem>
                            </BreadcrumbList>
                        </Breadcrumb>
