...
// ✅ Wire the margin simulator module
import MarginSimulatorModule from "@/modules/manufacturing-management/margin-simulator/MarginSimulatorModule";
...
export default async function MarginSimulatorPage() {
