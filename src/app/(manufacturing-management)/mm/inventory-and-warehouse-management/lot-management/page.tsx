...
// ✅ Wire the Lot Management module
import LotManagementModule from "@/modules/mm/inventory-and-warehouse-managemnet/lot-management";
                    ...
                    <div className="min-w-0 overflow-hidden">
                        <Breadcrumb>
                            ...
                            <BreadcrumbItem className="hidden md:block shrink-0">
                                ...
                                <BreadcrumbItem className="hidden md:block shrink-0">
                                    <BreadcrumbLink href="#">Inventory and Warehouse Management</BreadcrumbLink>
                                </BreadcrumbItem>
                                <BreadcrumbSeparator className="hidden md:block shrink-0" />
