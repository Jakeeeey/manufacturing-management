...
export const metadata = {
    title: "Item Management | VOS ERP",
    description: "Manage manufacturing catalog items, item types, and classifications."
};
    ...
    return (
        <div className="flex min-h-0 min-w-0 flex-1 flex-col overflow-hidden">
            ...
            <main className="min-h-0 min-w-0 flex-1 overflow-y-auto overflow-x-hidden p-4 sm:p-6 bg-background space-y-4">
                <div>
                    <h2 className="text-xl font-extrabold tracking-tight text-foreground">Item Management</h2>
                    <p className="text-muted-foreground text-[11px] mt-0.5">
                        Manage manufacturing catalog items, item types, and classifications.
                    </p>
                </div>
